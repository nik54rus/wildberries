...
class InlineResponse20024Data implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'inline_response_200_24_data';
    ...
    protected static $WildberriesTypes = [
        'error' => '\Wildberries\Client\Model\InlineResponse20024DataError[]'    ];
     ...
     * Gets error
     *
     * @return \Wildberries\Client\Model\InlineResponse20024DataError[]
     */
     ...
     * Sets error
     *
     * @param \Wildberries\Client\Model\InlineResponse20024DataError[] $error error
     *
     * @return $this
     */
