...
class InlineResponse20041Params implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'inline_response_200_41_params';
    ...
    protected static $WildberriesTypes = [
        'intervals' => '\Wildberries\Client\Model\InlineResponse20041Intervals[]',
'daily_budget' => 'int',
'price' => 'int',
'menu_id' => '',
'subject_id' => '',
...
'set_id' => 'getSetId'    ];
     ...
     * Gets intervals
     *
     * @return \Wildberries\Client\Model\InlineResponse20041Intervals[]
     */
     ...
     * Sets intervals
     *
     * @param \Wildberries\Client\Model\InlineResponse20041Intervals[] $intervals Интервалы часов показа РК
     *
     * @return $this
     */
