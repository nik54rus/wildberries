...
class SuppliesIdRespBody2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'suppliesIdRespBody2';
...
'error_text' => 'string',
'additional_errors' => '',
'data' => '\Wildberries\Client\Model\SuppliesIdRespBody2Data'    ];
...
'data' => 'getData'    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Client\Model\SuppliesIdRespBody2Data
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Client\Model\SuppliesIdRespBody2Data $data data
     *
     * @return $this
     */
