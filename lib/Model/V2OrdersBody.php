...
class V2OrdersBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'v2_orders_body';
    ...
    protected static $WildberriesTypes = [
        'order_id' => 'string',
'status' => 'int',
'sgtin' => '\Wildberries\Client\Model\Apiv2ordersSgtin[]'    ];
...
self::STATUS_9,        ];
     ...
     * Gets sgtin
     *
     * @return \Wildberries\Client\Model\Apiv2ordersSgtin[]
     */
     ...
     * Sets sgtin
     *
     * @param \Wildberries\Client\Model\Apiv2ordersSgtin[] $sgtin Массив КИЗов. Требуется только для фармацевтической продукции при переводе её в статус `6` (\"Клиент получил товар\").
     *
     * @return $this
     */
