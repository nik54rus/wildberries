...
class InlineResponse20027 implements ModelInterface, ArrayAccess
{
    ...
    protected static $WildberriesTypes = [
        'total' => 'int',
'orders' => '\Wildberries\Client\Model\InlineResponse20027Orders[]'    ];
...
'orders' => 'getOrders'    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Client\Model\InlineResponse20027Orders[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Client\Model\InlineResponse20027Orders[] $orders Список заказов.
     *
     * @return $this
     */
