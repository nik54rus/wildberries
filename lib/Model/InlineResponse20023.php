...
class InlineResponse20023 implements ModelInterface, ArrayAccess
{
    ...
    protected static $WildberriesTypes = [
        'total' => 'int',
'stocks' => '\Wildberries\Client\Model\InlineResponse20023Stocks[]'    ];
...
'stocks' => 'getStocks'    ];
     ...
     * Gets stocks
     *
     * @return \Wildberries\Client\Model\InlineResponse20023Stocks[]
     */
     ...
     * Sets stocks
     *
     * @param \Wildberries\Client\Model\InlineResponse20023Stocks[] $stocks Описание остатка товара.
     *
     * @return $this
     */
