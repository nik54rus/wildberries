...
self::DELIVERY_TYPE_FBS,        ];
     ...
     *
     * @param int $converted_price Цена продажи с учетом скидок в копейках, сконвертированная в валюту страны поставщика по курсу на момент создания сборочного задания. Предоставляется в информационных целях.
     *
     * @return $this
     */
     ...
     * Sets delivery_type
     *
     * @param string $delivery_type Тип доставки: fbs - доставка на склад Wildberries, dbs - доставка силами поставщика.
     *
     * @return $this
     */
